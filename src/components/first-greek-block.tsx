...
export function FirstGreekBlock() {
  const { lang } = useI18n();

  return (
    <div>
      <h2 className="display mb-6 text-3xl md:text-4xl">{ui.firstSection[lang]}</h2>
      <div className="grid gap-6 lg:grid-cols-[0.9fr_1.1fr] lg:items-start">
        ...
        <div>
          <h3 className="display text-3xl lg:text-5xl">{ui.personTitle[lang]}</h3>
